    ...
    : IRequestHandler<RefreshTokenQuery, Result<TokenResponse>>
{
    ...
    public async Task<Result<TokenResponse>> Handle(RefreshTokenQuery request, CancellationToken ct)
    {
        ...
        if (principal is null)
        {
            ...
            return ApplicationErrors.Tokens.ExpiredAccessTokenInvalid;
        }
        ...
        if (userId is null)
        {
            ...
            return ApplicationErrors.Tokens.UserIdClaimInvalid;
        }
        ...
        if (refreshToken is null || refreshToken.ExpiresOnUtc < DateTime.UtcNow)
        {
            ...
            return ApplicationErrors.Tokens.RefreshTokenExpired;
        }
