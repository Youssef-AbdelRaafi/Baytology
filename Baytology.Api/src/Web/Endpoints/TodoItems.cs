...
using Baytology.Api.Application.TodoItems.Commands.CreateTodoItem;
using Baytology.Api.Application.TodoItems.Commands.DeleteTodoItem;
using Baytology.Api.Application.TodoItems.Commands.UpdateTodoItem;
using Baytology.Api.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Baytology.Api.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace Baytology.Api.Web.Endpoints;
