...
namespace Baytology.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260401183407_AddFinalBusinessIntegrityHardening")]
    partial class AddFinalBusinessIntegrityHardening
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Baytology.Domain.Payments.PaymentTransaction", b =>
                {
                    ...
                    b.HasIndex("PaymentId", "GatewayReference", "TransactionStatus")
                        .IsUnique()
                        .HasFilter("[GatewayReference] IS NOT NULL AND [TransactionStatus] IS NOT NULL");
